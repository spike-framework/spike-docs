<div class="box" id="sp-project">
    <div class="title">sp-project</div>
    <div class="desc">
        ...
        <p>
            <b>sp-project</b> processor is used to create <b>if</b> statement which is <b>executed during compilation time</b>.
            <br/>
