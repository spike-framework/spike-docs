<div class="box" id="selectors">
    ...
    <div class="desc">
        ...
        It's also possible to access form using <b>$this.selector.forms</b> object:
        <pre>
            <code class="language-markup">
                <script type="prism-html-markup">
        ...
        Then you can access form this way:
        <pre>
            <code class="language-js">

                var form = $this.selector.forms.myForm();
